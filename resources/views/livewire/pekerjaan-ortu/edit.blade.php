    ...
    <div class="content-body">
        <div class="container pd-x-0">
                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                            ...
                            <li class="breadcrumb-item"><a href="/pekerjaan-ortu" wire:navigate>Pekerjaan Ortu</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit</li>
                        </ol>
                    </nav>
                    <h4 class="mg-b-0 tx-spacing--1">Edit Pekerjaan Ortu</h4>
                </div>
            </div>
            <form wire:submit="update()">
                    ...
                    <select wire:model="kriteria_id" class="form-select">
                        ...
                        @foreach ($kriterias as $kriteria)
                            <option value="{{ $kriteria->id }}"
                                {{ $pekerjaanOrtu->kriteria_id == $kriteria->id ? 'selected' : '' }}>
                                {{ $kriteria->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <a ref="/pekerjaan-ortu" wire::navigate class="btn btn-secondary" data-bs-dismiss="modal">Close</a>
