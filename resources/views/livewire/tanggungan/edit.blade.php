                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                            ...
                            <li class="breadcrumb-item"><a href="/tanggungan-ortu" wire:navigate>Tanggungan Ortu</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit</li>
                        </ol>
                    </nav>
                    <h4 class="mg-b-0 tx-spacing--1">Edit Tanggungan Ortu</h4>
                </div>
            </div>
                    ...
                    <select wire:model="kriteria_id" class="form-select">
                        ...
                        @foreach ($kriterias as $kriteria)
                            <option value="{{ $kriteria->id }}"
                                {{ $tanggungan->kriteria_id == $kriteria->id ? 'selected' : '' }}>
                                {{ $kriteria->nama }}
                            </option>
                        @endforeach
                    </select>
